...
exports.default = function (customConfig) {
  return function (commit, context) {
    ...
    commit.notes.forEach(function (note) {
      note.title = ((customConfig === null || customConfig === void 0 ? void 0 : customConfig.withEmoji) === false ? '' : '💥 ') + "BREAKING CHANGES";
      discard = false;
    });
    ...
    if (customConfig.displayScopes) {
      if (!((_a = customConfig.displayScopes) === null || _a === void 0 ? void 0 : _a.includes(commit.scope))) return;
    }

    if (customConfig.scopeDisplayName) {
      commit.scope = scopeMapDisplayName_1.scopeMapDisplayName(commit.scope, customConfig.scopeDisplayName);
    }
    ...
    if (typeof commit.subject === 'string') {
      var url_1 = context.repository ? context.host + "/" + context.owner + "/" + context.repository : context.repoUrl;
      ...
      if (context.host) {
        // User URLs.
        commit.subject = commit.subject.replace(/\B@([a-z0-9](?:-?[a-z0-9/]){0,38})/g, function (_, username) {
